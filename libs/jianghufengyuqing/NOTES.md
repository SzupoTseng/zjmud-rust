# 匯入與 WASM 落差紀錄 — jianghufengyuqing
...
| 項目 | 值 |
|------|-----|
| 收藏目錄 | `/mnt/g/GameDevZ/700600_ZJMUD_ALL/zjmud-collection-master/江湖风雨情` |
| mudlib 根 | `jhfyq` |
| 設定檔 | `（找不到）` |
| 匯入檔數 | 9087（14.0 MB） |
...
GBK → UTF-8 轉換 **8860** 個檔案。WASM build 只帶演算法式字集，表格式字集（GBK/BIG5）會 raise error，所以整個 lib 必須是 UTF-8。
...
| 映像 | 9086 檔 / 14 MB |
| 收到 | 424 行，耗時 4600 ms |
| 握手 | `ver1.0,$6$uWGBhbk6/a1v.4ey$3LqVF4Fywt0acRa0HtfYkFnea.uXFV98U9ux8s7Wt6l5BGnEAu6WhlgHYb00UyBYEupqjCzK6wWL0ep2FZz4w0` |
| 方言 | dmjh |
