...
int do_washto(string arg)
{
        ...
        if (tmpstr > 39 || tmpstr < 13)
                return notify_fail("你所选择的膂力数值要求必须在19和39之间。\n");

        if (tmpint > 39 || tmpint < 13)
                return notify_fail("你所选择的悟性数值要求必须在19和39之间。\n");

        if (tmpcon > 39 || tmpcon < 13)
                return notify_fail("你所选择的根骨数值要求必须在19和39之间。\n");

        if (tmpdex > 39 || tmpdex < 13)
                return notify_fail("你所选择的身法数值要求必须在19和39之间。\n");
