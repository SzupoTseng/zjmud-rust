...
void init()
{
	...
	add_action("discmds",({"walk","zdsm","recall","recalle","quit","chat","use","eat","fly","research","yanjiu","jiqu","derive","suicide","jobto","myshop","study","inventory","sleep","kill","fight","hit","conjure","expell","perform","prcatice","fly","exercise","respirate"}));
}
int discmds()
{
