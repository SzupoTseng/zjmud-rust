...
int main(object me, string arg)
{
	...
	if(!arg)
	{
		...
		write(ZJTTMENU"飞行:help ditu"ZJSEP"客栈:recall"ZJSEP"门派:recalle"ZJSEP"回家:huijia"ZJSEP"附近:help ditus"ZJSEP""HIR"充值"NOR":paym_zh"ZJSEP+HIG"其"HIC"他"NOR":help qt"NOR"\n");
	}
	else if(arg=="ofen")
	...
	else if(arg=="fight")
	{
		...
		write(ZJBTSET"b1:""更新"ZJBR"公告:help anews"ZJSEP"b2:""新手"ZJBR"指南"NOR":help newbie"ZJSEP"b3:""赞助"ZJBR"说明"NOR":help pay"ZJSEP"b4:"HIR"本服"ZJBR+HIM"特色"NOR":help ts"
			ZJSEP"b5:""笑傲"ZJBR"江湖:help xajh"ZJSEP"b6:""Web"ZJBR"设置:web"ZJSEP"b7:共享"ZJBR"指令"NOR":newbook1"ZJSEP"b8:""离线"ZJBR"任务"NOR":lixian"
