...
int main(object me, string arg)
{
	...
	if(!arg)
	{
		...
		ZJSEP"修改密码:changepasswd"ZJSEP"奇经八脉:beat"ZJSEP"建立家园:crroom"ZJSEP"扩建家园:crroom"ZJSEP"修改家园:edroom"ZJSEP"增加功能:edroom"ZJSEP"拆除场景:delroom"ZJSEP"家园开关:closeroom"ZJSEP"修改绰号:nick"ZJSEP"结拜兄弟:brothers"ZJSEP"武功排行:combat"ZJSEP"【本MUD目前所有武功排行】:syskill";
